...
class CoberturaClass extends CoberturaElement
{
    ...
    public static function create(string $className, string $relativeFilePath, array $classData, array $lineCoverageData): self
    {
        ...
        $class = new self($className, $relativeFilePath, $classData['executableLines'], $classData['executedLines'], $classData['executableBranches'], $classData['executedBranches'], $classData['ccn']);
    ...
    public static function createForFunctions(
        ...
        $class = new self($className, $relativeFilePath, $linesValid, $linesCovered, $branchesValid, $branchesCovered, $complexity);
    ...
    private function __construct(private string $name, private string $filename, int $linesValid, int $linesCovered, int $branchesValid, int $branchesCovered, private float $complexity)
    {
