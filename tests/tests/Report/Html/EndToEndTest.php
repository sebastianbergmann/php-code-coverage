...
final class EndToEndTest extends TestCase
{
    ...
    public function testLineCoverageForBankAccountTest(): void
    {
        ...
        $report = new Facade;
        $report->process($this->getLineCoverageForBankAccount()->buildReport(), false, self::$TEST_TMP_PATH);
    ...
    public function testPathCoverageForBankAccountTest(): void
    {
        ...
        $report = new Facade;
        $report->process($this->getPathCoverageForBankAccount()->buildReport(), true, self::$TEST_TMP_PATH);
    ...
    public function testPathCoverageForSourceWithoutNamespace(): void
    {
        ...
        $report = new Facade;
        $report->process($this->getPathCoverageForSourceWithoutNamespace()->buildReport(), true, self::$TEST_TMP_PATH);
    ...
    public function testForFileWithIgnoredLines(): void
    {
        ...
        $report = new Facade;
        $report->process($this->getCoverageForFileWithIgnoredLines()->buildReport(), false, self::$TEST_TMP_PATH);
    ...
    public function testForClassWithAnonymousFunction(): void
    {
        ...
        $report = new Facade;
        $report->process($this->getCoverageForClassWithAnonymousFunction()->buildReport(), false, self::$TEST_TMP_PATH);
