...
final class Crap4jTest extends TestCase
{
    public function testForBankAccountTest(): void
    {
        ...
        $this->assertStringMatchesFormatFile(
            ...
            $crap4j->process($this->getLineCoverageForBankAccount()->buildReport(), null, 'BankAccount')
        );
    }
    ...
    public function testForFileWithIgnoredLines(): void
    {
        ...
        $this->assertStringMatchesFormatFile(
            ...
            $crap4j->process($this->getCoverageForFileWithIgnoredLines()->buildReport(), null, 'CoverageForFileWithIgnoredLines')
        );
    }
    ...
    public function testForClassWithAnonymousFunction(): void
    {
        ...
        $this->assertStringMatchesFormatFile(
            ...
            $crap4j->process($this->getCoverageForClassWithAnonymousFunction()->buildReport(), null, 'CoverageForClassWithAnonymousFunction')
        );
    }
}
